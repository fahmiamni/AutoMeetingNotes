...
chunk_chars = int(os.getenv('SUMMARY_CHUNK_CHARS', '24000'))
max_tokens = int(os.getenv('SUMMARY_MAX_TOKENS', '1200'))
...
if len(chunks) == 1:
    ...
    for index, chunk in enumerate(chunks, start=1):
        print(f"Summarizing chunk {index}/{len(chunks)} with {model_name}...")
